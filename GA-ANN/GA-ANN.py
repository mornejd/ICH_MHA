import os
import math
os.chdir('C:\\Users\\Administrator\\Desktop\\Softwares\\Programming\\GA-ANN')
...
# Load the dataset
df = pd.read_excel("C:\\Users\\Administrator\\Desktop\\Softwares\\Programming\\data_balanced_SMOTE.xlsx")
...
best_solution, best_scores, best_scores_over_time = genetic_algorithm(X_train, y_train, X_test, y_test, num_generations=250, population_size=20, num_parents_mating=10, mutation_rate=0.1)
