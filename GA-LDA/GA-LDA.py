import os
import math
os.chdir('C:\\Users\\LEGION\\OneDrive\\IT Onedrive\\PHD\\Paper\\Ali Paper\\PONE\\Revise\\Code\\GA-LDA')
...
best_solution, best_scores, best_scores_over_time = genetic_algorithm(X_train, y_train, X_test, y_test, 250, 40, 20, 0.1)
